...
const RepairLab = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{`מעבדת תיקונים | ${store?.name || 'PowerDev'}`}</title>
                <meta name="description" content="מעבדת תיקונים מקצועית למכשירי סלולר, טאבלטים ומחשבים ניידים. שירות מהיר, אמין ומקצועי עם אחריות על כל תיקון. בדיקת סטטוס תיקון מהירה באתר." />
                <link rel="canonical" href={typeof window !== 'undefined' ? window.location.href : ''} />
                <meta property="og:title" content={`מעבדת תיקונים | ${store?.name || 'PowerDev'}`} />
                <meta property="og:description" content="מעבדת תיקונים מקצועית למכשירי סלולר, טאבלטים ומחשבים ניידים. שירות מהיר, אמין ומקצועי עם אחריות על כל תיקון." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={typeof window !== 'undefined' ? window.location.href : ''} />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={`מעבדת תיקונים | ${store?.name || 'PowerDev'}`} />
                <meta name="twitter:description" content="מעבדת תיקונים מקצועית למכשירי סלולר, טאבלטים ומחשבים ניידים. שירות מהיר, אמין ומקצועי." />
            </Helmet>

            <BreadcrumbSchema items={[
                { name: store?.name || 'PowerDev', url: '/' },
                { name: 'מעבדת תיקונים', url: typeof window !== 'undefined' ? window.location.href : '' }
            ]} />
                                        ...
                                        <div key={item._id} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:-translate-y-1 transition-transform duration-300 group flex flex-col justify-between">
                                            <div>
                                                <div className="flex justify-between items-start mb-4">
                                                    ...
                                                    {hidePrice ? (
                                                        <span className="text-lg font-bold text-sky-600 bg-sky-50 px-3 py-1 rounded-lg">צור קשר</span>
                                                    ) : (
