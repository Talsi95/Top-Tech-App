...
const ArticlesPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>{`מאמרים ובלוג | ${storeName}`}</title>
                <meta name="description" content={`כתבות, מדריכים ועדכונים מבית ${storeName}. טיפים מקצועיים, המלצות ומידע מעניין על המוצרים והשירותים שלנו.`} />
                <link rel="canonical" href={pageUrl} />
                <meta property="og:title" content={`מאמרים ובלוג | ${storeName}`} />
                <meta property="og:description" content={`כתבות, מדריכים ועדכונים מבית ${storeName}. טיפים מקצועיים, המלצות ומידע מעניין.`} />
                <meta property="og:url" content={pageUrl} />
                <meta property="og:type" content="website" />
                {store?.design?.logoUrl && <meta property="og:image" content={store.design.logoUrl} />}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={`מאמרים ובלוג | ${storeName}`} />
                <meta name="twitter:description" content={`כתבות, מדריכים ועדכונים מבית ${storeName}.`} />
            </Helmet>

            <BreadcrumbSchema items={[
                { name: storeName, url: '/' },
                { name: 'מאמרים', url: pageUrl }
            ]} />
