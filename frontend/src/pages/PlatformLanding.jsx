...
const PlatformLanding = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f8f9fb] text-[#191c1e] flex flex-col font-sans" dir="rtl">
            ...
            {/* Hero Section */}
            <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-950 text-white">
                ...
                <div className="relative max-w-4xl mx-auto text-center px-6">
                    ...
                    <p className="text-lg md:text-xl text-indigo-200/90 font-medium max-w-2xl mx-auto leading-relaxed mb-10">
